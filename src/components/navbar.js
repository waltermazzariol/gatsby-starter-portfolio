    ...
    return (
        <Navbar className="navbar navbar-expand-lg navbar-light fixed-top py-0" id="mainNav" expand="lg" collapseOnSelect={true}>
          <div className="container">
            ...
            <div className="navbar-cta d-sm-block d-md-block d-lg-none"><a href={this.props.nav.cta_link} target="_blank" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a></div>
            ...
            <div className="navbar-cta d-none d-lg-block d-xl-block"><a href={this.props.nav.cta_link} target="_blank" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a></div>
          </div>
        </Navbar>
    );
  }
