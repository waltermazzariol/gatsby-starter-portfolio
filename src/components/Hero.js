  ...
  return (
    <div as={"header"} className="hero">
      ...
      <div className="hero-wrapper d-flex flex-column justify-content-center align-items-center text-center" >
            ...
            <Fade><button className="button-basic mt-4"><a href={props.nav.cta_link} target="_blank" rel="noopener noreferrer"><i className={`fab fa-${props.nav.cta_type} me-2`}></i>{props.nav.cta_button}</a></button></Fade>
      </div>
    </div>
  )
}
