  ...
  return (
    <Navbar className="navbar navbar-expand-lg navbar-light fixed-top py-0" id="mainNav" expand="lg" collapseOnSelect={true}>
      <div className="container">
        ...
        <div className="btn-basic d-sm-block d-md-block d-lg-none"><a href={props.nav.cta_link} target="_blank" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a></div>
        ...
        <div className="btn-basic d-none d-lg-block d-xl-block"><a href={props.nav.cta_link} target="_blank" rel="noopener noreferrer"><i className="fab fa-whatsapp mr-2"></i>{props.nav.cta_button}</a></div>
      </div>
    </Navbar>
  );
}
