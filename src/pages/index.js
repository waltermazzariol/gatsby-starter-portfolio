    ...
    <Layout nav={contentJson.navigation} >
      ...
      <Section anchor={'about'} className={'about'} >
        ...
        <Col md="12" lg="5" align="text-center">
          <Fade>
            <Img className="shadow-image mb-4" fluid={contentJson.about.image.childImageSharp.fluid} alt="profile" />
          </Fade>
        </Col>
        <Col md="12" lg="7">
          <Fade>
      ...
      <Section anchor={'location'} className={'contact'} fluid={true} noGutters={true}>
