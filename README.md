...
<h1 align="center">
  Gatsby Start Bootstrap Portfolio
</h1>
...
- [React parallax | Parallax for pictures](https://www.npmjs.com/package/react-parallax)
- [react-reveal | Animation effects](https://www.react-reveal.com/)
- [React ga | Google Analytics](https://github.com/react-ga/react-ga)
- [Fetch Instagram Pictures](https://github.com/react-ga/react-ga)
...
1.  **Create a Gatsby site.**
    ...
    ```sh
    gatsby new project-name https://github.com/waltermazzariol/Personal-portfolio-starter-Gatsby
    ```
